...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    [detailLable setTextAlignment:NSTextAlignmentLeft];
    [detailLable setFont:MESSAGE_TIME_FONT];
    [detailLable setTextColor:[UIColor grayColor]];
    [self.contentView addSubview:detailLable];
    self.detailLabel = detailLable;
...
- (void)setMessageFrame:(MessageFrame *) messageFrame {
    ...
    self.detailLabel.text = messageFrame.message.name;
    self.detailLabel.frame = messageFrame.nameFrame;
