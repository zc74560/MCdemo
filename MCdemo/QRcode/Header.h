...
#define kTipY               (kBgImgY+kBgImgWidth+kTipHeight-30*ratio)
#define kTipHeight          100*ratio

#define kLampX              ([[UIScreen mainScreen] bounds].size.width-kLampWidth)/2
#define kLampY              ([[UIScreen mainScreen] bounds].size.height-kLampWidth-120*ratio)
#define kLampWidth          160*ratio

#define kshowQRX              (90*ratio)
#define kshowQRY              ([[UIScreen mainScreen] bounds].size.height-kLampWidth-120*ratio)
#define kshowQRWidth          160*ratio

#define kphotoX              ([[UIScreen mainScreen] bounds].size.width-90*ratio-kLampWidth)
#define kphotoY              ([[UIScreen mainScreen] bounds].size.height-kLampWidth-120*ratio)
